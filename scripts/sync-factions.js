...
function categoryOf(entry) { return entry.canonical === 'Neutral' ? 'neutral' : entry.canonical === 'Narmer' ? 'special' : ['Arbiters of Hexis', 'Red Veil', 'Steel Meridian', 'Cephalon Suda', 'New Loka', 'The Perrin Sequence'].includes(entry.canonical) ? 'syndicate' : 'major' }
